...
# Clonar repositório
RUN git clone git@github.com:Vieirauc/uc-msc-luisv-classification.git /workspace/uc-msc-luisv-classification
WORKDIR /workspace/uc-msc-luisv-classification
